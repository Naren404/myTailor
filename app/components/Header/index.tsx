                    ...
                    dark:shadow-none dark:bg-gray-800 dark:border-gray-700">
                      ...
                      <div className="text-gray-600 dark:text-gray-300 lg:pr-4 lg:w-auto w-full lg:pt-0">
                        <ul className="tracking-wide font-medium lg:text-sm flex-col flex lg:flex-row gap-6 lg:gap-0">
                          <li>
                            <Link to="/" className="block md:px-4 transition hover:text-primary">HOME</Link>
                          </li>

                          <li>
                            <Link to="/" className="block md:px-4 transition hover:text-primary">ABOUT</Link>
                          </li>
                        </ul>
                      </div>

                      <div className="mt-12 lg:mt-0">
                        <a className="relative flex h-9 w-full items-center justify-center px-4 before:absolute before:inset-0 before:rounded-full before:bg-primary before:transition before:duration-300 hover:before:scale-105 active:duration-75 active:before:scale-95 sm:w-max">
